...
<body>
    <!--Barra de navegación-->
        ...
        <span class="d-inline-block">
            ...
            <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#add_producto">Añadir producto</a>
            <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#ed_user">Actualizar mis datos</a>
        </span>
        </section>
        <section>
